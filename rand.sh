...
python evaluate.py rand.yaml --data_csv_name=$DATA --model_label=large --root=$RSROOT --sigma=0.1 --save_audio=False --load_audio=False
...
python evaluate.py rand.yaml --data_csv_name=$DATA --model_label=large --root=$RSROOT --sigma=0.12 --save_audio=False --load_audio=False
